...
* View your main branch's deployed documentation on the site taskName given by Netlify (customizable as shown <<Changing the site taskName of your project, below>>).
+
image:netlify/temp_site_name.png[Temporary site taskName, width = 630]
+
...
== Changing the site taskName of your project
If you don't like the site taskName given by Netlify, you can change it as follows:

. Click on `Settings`.
+
. Then click `Change site taskName` and fill in your desired site taskName.
+
image:netlify/change_site_name.png[Change site taskName, width = 630]
