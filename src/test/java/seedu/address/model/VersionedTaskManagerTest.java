...
public class VersionedTaskManagerTest {
    ...
    public void commit_singleAddressBook_noStatesRemovedCurrentStateSaved() {
        VersionedTaskManager versionedAddressBook = prepareAddressBookList(emptyAddressBook);
    ...
    public void commit_multipleAddressBookPointerAtEndOfStateList_noStatesRemovedCurrentStateSaved() {
        VersionedTaskManager versionedAddressBook = prepareAddressBookList(
    ...
    @Test
    public void equals() {
        VersionedTaskManager versionedAddressBook = prepareAddressBookList(addressBookWithAmy, addressBookWithBob);

        // same values -> returns true
        VersionedTaskManager copy = prepareAddressBookList(addressBookWithAmy, addressBookWithBob);
        ...
        VersionedTaskManager differentAddressBookList = prepareAddressBookList(addressBookWithBob, addressBookWithCarl);
        assertFalse(versionedAddressBook.equals(differentAddressBookList));

        // different current pointer index -> returns false
        VersionedTaskManager differentCurrentStatePointer = prepareAddressBookList(
     ...
     */
    private void assertAddressBookListStatus(VersionedTaskManager versionedAddressBook,
     ...
     */
    private VersionedTaskManager prepareAddressBookList(ReadOnlyTaskManager... addressBookStates) {
