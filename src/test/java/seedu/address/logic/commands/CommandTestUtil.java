...
public class CommandTestUtil {
    ...
    public static final String PHONE_DESC_AMY = " " + PREFIX_MODULE + VALID_PHONE_AMY;
    public static final String PHONE_DESC_BOB = " " + PREFIX_MODULE + VALID_PHONE_BOB;
    ...
    public static final String INVALID_PHONE_DESC = " " + PREFIX_MODULE + "911a"; // 'a' not allowed in phones
