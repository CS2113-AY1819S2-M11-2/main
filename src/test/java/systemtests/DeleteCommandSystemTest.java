...
public class DeleteCommandSystemTest extends PriorityBookSystemTest {
     ...
     * {@code PriorityBookSystemTest#assertApplicationDisplaysExpected(String, String, Model)}.
     * @see PriorityBookSystemTest#assertApplicationDisplaysExpected(String, String, Model)
     */
     ...
     * @see DeleteCommandSystemTest#assertCommandSuccess(String, Model, String)
     * @see PriorityBookSystemTest#assertSelectedCardChanged(Index)
     */
    private void assertCommandSuccess(String command, Model expectedModel, String expectedResultMessage,
     ...
     * Verifications 1 and 2 are performed by
     * {@code PriorityBookSystemTest#assertApplicationDisplaysExpected(String, String, Model)}.<br>
     * @see PriorityBookSystemTest#assertApplicationDisplaysExpected(String, String, Model)
     */
